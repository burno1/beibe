            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item active"><a class="nav-link" href='ClienteServlet'>Cadastro Funcionário<span class="sr-only">(current)</a></li>
                ...
                <form action="InserirClienteServlet" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <a href="funcionarioListar.jsp"><button type="button" class="btn btn-secondary">Cancelar</button></a>
                            </div>
                        </div>
                </form>
